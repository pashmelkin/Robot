...
describe('Processor', function () {
    it('MoveRobot function returns correct location after correct place command', function () {
    ...
    it('MoveRobot function returns does not change location after wrong place command', function () {
        const repo = new Repository(correctLocation);
        const processor = new Processor(repo);
